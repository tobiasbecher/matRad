...
ctDim = [150,150,80]; % y,x,z dimensions
...
objective1 = struct(DoseObjectives.matRad_SquaredDeviation(0.1,45));
objective2 = struct(DoseObjectives.matRad_SquaredOverdosing(100,0));
objective3 = struct(DoseObjectives.matRad_SquaredOverdosing(0.1,0));     
...
cst{1,6}{2} = DoseConstraints.matRad_MinMaxDose(36/(30/n),56/(30/n))
%%
...
% fluence optimization
%%
resultGUI_singleModalityTwoJO = matRad_fluenceOptimizationJO(dij_singleModalityTwoJO, cst, pln_2);
%}
'a'
%% Joint optimization
% 
