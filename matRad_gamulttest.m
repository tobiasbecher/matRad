...
[resultGUIs,opts,cst] = matRad_gamultobjopt(dij,cst,pln);
%%
aaaaaaaaaaaaa
%%
%save('resultssimplephantomgamultiobj.mat','-v7.3','resultGUIs');
%load('resultssimplephantomgamultiobj.mat','-v7.3','resultGUIs');%%
fVals = resultGUIs.info.fVal;
%%
plot(fVals(:,1),fVals(:,2),'.');
%%
ws = resultGUIs.xs;
%%
fs = matRad_objectiveFunctions(ws(1,:),dij,cst);
%%
aaaa
%%
for i = 1:size(ws,1)
