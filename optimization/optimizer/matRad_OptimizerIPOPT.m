...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    methods
        function obj = matRad_OptimizerIPOPT
            ...
            obj.options.acceptable_constr_viol_tol    = 1e-3; % (Acc3)
        ...
        function obj = optimize(obj,w0,optiProb,dij,cst)
            ...
            funcs.constraints       = @(x) optiProb.matRad_constraintFunctions2(x,dij,cst);
            funcs.gradient          = @(x) optiProb.matRad_objectiveGradient2(x,dij,cst);
            funcs.jacobian          = @(x) optiProb.matRad_constraintJacobian2(x,dij,cst);
            funcs.jacobianstructure = @( ) optiProb.matRad_getJacobianStructure2(w0,dij,cst);
